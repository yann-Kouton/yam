...
import { Users, Ban, RotateCcw, Store, CheckCircle2, XCircle } from 'lucide-react'
            ...
            {filtered.map(u => (
              <div key={u.id} className="card p-4">
                ...
                {u.vendorRequestStatus === VENDOR_REQUEST_STATUS.PENDING && (
                  <div className="flex items-center gap-2 mb-2 bg-[var(--secondary-light)] rounded-xl p-2.5">
                    <Store className="w-4 h-4 text-[var(--secondary)] shrink-0" />
                    <p className="text-xs text-[var(--secondary)] flex-1">Souhaite devenir vendeur</p>
